...
<body>
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark  align-middle justify-content-center">
            <ul class="navbar-nav ">    
                <li class="nav-item">
                    <a class="btn btn-sm btn-outline-success" href="caixa_entrada.php">Caixa de Entrada</a>
                </li>
            </ul>
            <ul class="navbar-nav ">
                <li class="nav-item">
                    <a class="btn btn-sm btn-outline-light" href="caixa_saida.php">Caixa de Saída</a>
                </li>
            </ul>
            <ul class="navbar-nav ">
                <li class="nav-item">
    ...
    <?php
        ...
        if($con){
            ...
            $sql = "SELECT u.nome, u.sobrenome, u.email, e.data, e.assunto, e.mensagem FROM usuario AS u JOIN email AS e ON destinatario=$usuario WHERE u.id=e.remetente";
